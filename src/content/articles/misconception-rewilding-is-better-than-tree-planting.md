...
- 
[Climate change is impacting environments](https://www.protect.earth/blog/right-tree-right-place-right-now) faster than our remaining fragile ecosystems can handle.

According to [Forest Research](https://www.forestresearch.gov.uk/tools-and-resources/statistics/statistics-by-topic/woodland-statistics/), thirteen per cent of the total land area in the UK features woodland. It gets even worse when you look at the stats for specific types of woodlands. The UK once had up to 20% temperate rainforest coverage! Today, that magnificent type of woodland is less than 1% of land use in the UK. Nothing comes from nothing, and with the sparsity of woodlands coverage, we can't expect [n](https://www.protect.earth/blog/right-tree-right-place-right-now)atural colonisation alone to be very effective.
